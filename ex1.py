...
exercise_data = {
    "유산소 운동": {
        "러닝": {
            ...
            "영상": None,
            "이미지": "https://cdn.pixabay.com/photo/2016/11/21/12/59/beach-1840430_1280.jpg"
        },
        "점핑잭": {
            "난이도": "⭐⭐",
    ...
    "근력 강화": {
        ...
        "플랭크": {
            ...
            "영상": None,
            "이미지": "https://cdn.pixabay.com/photo/2016/11/22/23/35/plank-1850925_1280.jpg"
        },
        "런지": {
            "난이도": "⭐⭐",
            "설명": "허벅지와 엉덩이 근육을 고르게 발달시키는 운동.",
            "영상": None,
            "이미지": "https://cdn.pixabay.com/photo/2017/08/06/11/32/girl-2592247_1280.jpg"
        }
    },
    "유연성 & 재활": {
        "목 스트레칭": {
            ...
            "영상": None,
            "이미지": "https://cdn.pixabay.com/photo/2016/11/21/15/55/woman-1842121_1280.jpg"
        },
        "전신 스트레칭": {
            "난이도": "⭐⭐",
    ...
    "요가": {
        "다운독": {
            ...
            "영상": None,
            "이미지": "https://cdn.pixabay.com/photo/2017/03/01/20/27/yoga-2111968_1280.jpg"
        },
        "나무자세": {
            "난이도": "⭐⭐",
            "설명": "균형감각을 기르고 집중력을 향상시키는 요가 자세.",
            "영상": None,
            "이미지": "https://cdn.pixabay.com/photo/2016/11/29/09/32/meditation-1869992_1280.jpg"
        }
    }
}
        ...
        for 카테고리, 운동들 in exercise_data.items():
            if 운동 in 운동들:
                ...
                if info["영상"]:
                    ...
                    st.image(info["이미지"], caption=f"{운동} 예시 동작")
